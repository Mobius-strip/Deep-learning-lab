...
def training(local_rank, config):
    ...
    logger = setup_logger(name="svnh-Training")
    ...
    def run_validation(engine):
        ...
        max_memory_usage = torch.cuda.max_memory_allocated() / 1024 / 1024 # convert to MB
        logger.info(f"Epoch {epoch} - Max memory usage: {max_memory_usage:.2f} MB")
